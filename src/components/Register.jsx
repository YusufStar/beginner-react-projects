...
function Register() {
  ...
  return (
    <div className='flex items-center justify-center h-screen bg-gray-800'>
      <form className="flex flex-col items-center justify-center gap-5 w-[75vw] h-[60vh] bg-gray-900 rounded-xl" onSubmit={() => {alert(`name: ${input.name}, surname: ${input.surname}, email: ${input.email}`)}}>
        ...
        <button type='submit' className='border-2 border-red-900 rounded-lg w-[40%] h-[10%] text-s text-white hover:bg-red-900 transition-all'>Register</button>
        <BackToHome />
      </form>
    </div>
  )
